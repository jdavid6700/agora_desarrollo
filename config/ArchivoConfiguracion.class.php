...
class ArchivoConfiguracion {
	...
	/**
         * Carga el archivo de configuración de acuerdo el entorno establecido en Amazon
         */
	function cargarArchivoConfiguracion($path=''){
                $oas_external_env = getEnv('OAS_EXTERNAL_ENV');
                switch ($oas_external_env) {
                    case 'develop':
                        return $path.'/config_develop.inc.php';
                        break;
                    case 'master':
                        return $path.'/config_master.inc.php';
                        break;
                    default:
                        return $path.'/config_develop.inc.php';
                        break; 

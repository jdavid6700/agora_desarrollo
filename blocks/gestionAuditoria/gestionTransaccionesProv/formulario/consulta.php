...
class registrarForm {
    ...
    function miForm() {
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Consultar Auditoría Contratos";
        echo $this->miFormulario->marcoAgrupacion('inicio', $atributos); {
            
            echo "<div id='oneAudit'>";
            ...
            $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("vigencias_existentes");
            $atributos ['matrizItems'] = $DBFrameWork->ejecutarAcceso($atributos ['cadena_sql'], "busqueda");

...
class registrarForm {
    ...
    function miForm() {
        ...
        $cadenaSqlevento = $this->miSql->getCadenaSql('obtenerInfoAuditoriaAgoraId', $_REQUEST ['id']);
        ...
        if($usuarioRol){
            ...
            $_REQUEST ['tipo_persona'] = $evento[0]['tipo_persona'];
            $_REQUEST ['documento'] = $evento[0]['documento'];        
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "CONSULTAR AUDITORÍA ERROR PROVEEDOR <br>" ;
        ...
        unset($atributos); 
                ...
                $variable .= "&opcion=rcProv";

                $variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable, $directorio);



                if($evento[0]['tipo_log'] === 'REGISTRO'){
                    $registroEve = true;

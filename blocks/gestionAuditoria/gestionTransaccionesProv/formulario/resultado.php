...
class registrarForm {
    ...
    function miForm() {
         ...
         */ {
            ...
            $cadenaSql = $this->miSql->getCadenaSql('consultarContratosGeneralAudit', $arreglo);
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Contratos Suscritos para Modificar";
        ...
        if ($contratos) {
            ...
            foreach ($contratos as $valor) {
                ...
                $variable .= "&opcion=consultarContratoAudit";
                $variable .= "&id=" . $valor ['id'];
                $variable .= "&consecutivo_contrato=" . $valor ['consecutivo_contrato'];
                $variable .= "&vigencia=" . $valor ['vigencia'];
                $variable .= "&clase_contrato=" . $valor ['tipo_contrato'];
                $variable .= "&mensaje_titulo=  Contrato: " . $valor ['tipo_contrato'] . " | VIGENCIA: " . $valor ['vigencia'] . " | NÚMERO CONSECUTIVO CONTRATO : " . $valor ['consecutivo_contrato'];
                ...
                $mostrarHtml = "<tr>
                    ...
                    <td><center>" . $valor ['consecutivo_contrato'] . "</center></td>";
                $mostrarHtml .= "<td><center>" . $valor['tipo_contrato'] . "</td>";

                $mostrarHtml .= "<td><center>" . $valor['tipo_log'] . "</td>";
                ...
                $mostrarHtml .="
                    <td><center>" . $valor ['estado_contrato'] . "</center></td>
                    <td><center>
                    	<a href='" . $variable . "'>

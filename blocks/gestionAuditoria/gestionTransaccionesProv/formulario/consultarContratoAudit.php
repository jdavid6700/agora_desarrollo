...
class registrarForm {
    ...
    function miForm() {
        ...
        if($usuarioRol){
            ...
            if($evento[0]['data'] != null){
                ...
                foreach ($json_data as $item => $value){
                   ...
                   $tbDt = '                                 
                        <section>
                            <h2 class="acc_title_bar"><a href="#">'."INFORMACIÓN TABLA (".$item."):".'</a></h2>
                            <div class="acc_container">
                                <div class="block" align="center">
                    ';
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "CONSULTAR AUDITORÍA PROVEEDOR <br>";

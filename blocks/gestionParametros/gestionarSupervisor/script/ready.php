...
function detectarCarga(){
	...
	$('#marcoDatosLoad2').fadeOut(1000, function (){
		$('#marcoDatosTable').fadeIn(500);
		$('#marcoDatos').fadeIn(500);
	});
...
$("#gestionarSupervisor").validationEngine({
...
$('#<?php echo $this->campoSeguro('tipoFuncionario')?>').width(350);
$("#<?php echo $this->campoSeguro('tipoFuncionario')?>").select2();

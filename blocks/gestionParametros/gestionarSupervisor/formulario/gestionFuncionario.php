    ...
    function miForm() {
      ...
      $coreRecursoDB = $this->miConfigurador->fabricaConexiones->getRecursoDB($conexion);
       ...
       if (isset($_REQUEST ['dependencia']) && $_REQUEST ['dependencia'] != '') {
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultarInformacionFuncionario', $_REQUEST['id']);
        $funcionarioInfo = $coreRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");

        $cadenaSql = $this->miSql->getCadenaSql('consultarInformacionTercero', $funcionarioInfo[0]['tercero_id']);
        $funcionarioInfoTercero = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Modificar ". $tipofun;
        echo $this->miFormulario->marcoAgrupacion('inicio', $atributos); {
            ...
            $tipo = 'success';
            $mensaje =  "<br>Modificación <b>". $tipofun ."</b>
            ...
            echo $this->miFormulario->marcoAgrupacion('inicio', $atributos);
                ...
                echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
                    ...
                    if (isset($_REQUEST [$esteCampo])) {
                        ...
                        $atributos ['valor'] = $funcionarioInfoTercero[0]['proveedor'];
                    }
                    ...
                    if (isset($_REQUEST [$esteCampo])) {
                        ...
                        $atributos ['valor'] =  $funcionarioInfo[0]['tercero_id'];
                    }
                    $atributos = array_merge($atributos, $atributosGlobales);
                    echo $this->miFormulario->campoCuadroTexto($atributos);
                    unset($atributos);
                ...
                //---------------------------------TEMP-------------------------
                        ...
                        if (isset($_REQUEST [$esteCampo])) {
                            ...
                            $atributos ['valor'] =  $funcionarioInfo[0]['acta_aprobacion'];
                        }
                        $tab ++;
                ...
                if (isset($_REQUEST [$esteCampo])) {
                    ...
                    $atributos ['valor'] = $this->cambiafecha_format($funcionarioInfo[0]['fecha_inicio']);
                }
                ...
                //---------------------------------TEMP-------------------------
                $esteCampo = 'fecha_inicio_hidden';
                $atributos ['id'] = $esteCampo;
                $atributos ['nombre'] = $esteCampo;
                $atributos ['tipo'] = 'hidden';
                $atributos ['estilo'] = 'jqueryui';

                if (isset($_REQUEST ['fecha_inicio_hidden'])) {
                    $atributos ['valor'] = $_REQUEST ['fecha_inicio_hidden'];
                } else {
                    $atributos ['valor'] = $this->cambiafecha_format($funcionarioInfo[0]['fecha_inicio']);
                }
                ...
                $atributos ['tabIndex'] = $tab;
                $atributos ['etiqueta'] = $this->lenguaje->getCadena($esteCampo);
                $atributos ['validar'] = 'required, minSize[10],mSaxSize[10]';
                $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                $atributos ['deshabilitado'] = false;
                $atributos ['tamanno'] = 10;
                $atributos ['maximoTamanno'] = '';
                ...
                if (isset($_REQUEST [$esteCampo])) {
                    ...
                    $atributos ['valor'] = $this->cambiafecha_format($funcionarioInfo[0]['fecha_fin']);
                }
                        $tab ++;
                // Aplica atributos globales al control
                $atributos = array_merge($atributos, $atributosGlobales);
                ...
                unset($atributos);
                 echo $this->miFormulario->marcoAgrupacion('fin');
                  ...
                  //---------------------------------TEMP-------------------------
                $esteCampo = 'fecha_fin_hidden';
                $atributos ['id'] = $esteCampo;
                $atributos ['nombre'] = $esteCampo;
                $atributos ['tipo'] = 'hidden';
                $atributos ['estilo'] = 'jqueryui';

                if (isset($_REQUEST ['fecha_fin_hidden'])) {
                    $atributos ['valor'] = $_REQUEST ['fecha_fin_hidden'];
                } else {
                    $atributos ['valor'] = $this->cambiafecha_format($funcionarioInfo[0]['fecha_fin']);
        ...
        $valorCodificado .= "&id_registro=" .  $_REQUEST ['id'];
        $valorCodificado .= "&opcion=modificoFuncionario";

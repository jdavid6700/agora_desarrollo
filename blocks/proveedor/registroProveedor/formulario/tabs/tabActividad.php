...
class FormularioRegistro {
	...
	function formulario() {
		...
		$_REQUEST['idProveedor'] = $datosProvedor[0][3];
		...
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );                
			...
			//INICIO INFORMACION 
				...
				echo "<span class='textoElegante textoMediano textoGris'>". $datosProvedor[0][0] . "</span></br>"; 
				echo "<span class='textoElegante textoEnorme textoAzul'>Nombre de la Empresa : </span>"; 
				echo "<span class='textoElegante textoMediano textoGris'>". $datosProvedor[0][1] . "</span></br>"; 
				echo "<span class='textoElegante textoEnorme textoAzul'>Correo : </span>"; 
				echo "<span class='textoElegante textoMediano textoGris'>". $datosProvedor[0][2] . "</span></br>";                 
			//FIN INFORMACION 

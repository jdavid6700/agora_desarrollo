...
if ($resultado) {
		...
		unset ( $atributos );
			...
			<table class="table table-bordered table-striped table-hover table-condensed">
				<tr class="info">
							<td align="center"><strong>N&uacute;mero Contrato</strong></td>	
							<td align="center"><strong>Fecha Inicio</strong></td>
							<td align="center"><strong>Fecha Final</strong></td>
							<td align="center"><strong>Valor</strong></td>
							<td align="center"><strong>Certificado Universidad</strong></td>
							<td align="center"><strong>Certificado Cumplimiento</strong></td>
...
if( $hoy > $dato['fecha_finalizacion'] ){
	...
	$msj = 'El contrato no se ha liquidado';
	...
	$variable = '#';
					...
					echo "<tr>";
					echo "<td align='center'>" . $dato['numero_contrato'] . "</td>";

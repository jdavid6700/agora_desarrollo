...
//         $valorCodificado.="&estadoSolicitudAct=CON ACTIVIDADES Y NBC";
    	...
    	if($_REQUEST['estado'] == '3'){
    		$dec = "MODIFICACIÓN APROBADA";
    	}else{
    		$dec = "MODIFICACIÓN RECHAZADA";
    	}
    	
        $tipo = 'success';
        $mensaje = "Se proceso satisfactoriamente la Petición de Modificación de Cotización <b>("."SMC-" . sprintf("%06d", $_REQUEST['idObjeto']).")</b>.<br>
        		<br>

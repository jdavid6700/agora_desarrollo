...
class Formulario {
	...
	function formulario() {
		...
		$this->cadena_sql = $this->miSql->getCadenaSql ( "listarObjetosParaCotizacionByOrdenador", $confirmarOrdenador[0]['id'] );
		$resultado = $esteRecursoDB->ejecutarAcceso ( $this->cadena_sql, "busqueda" );
		...
		if ($resultado) {
			...
			$tipo = 'success';
			$mensaje =  "Lista de Solicitudes de Cotización Disponibles para Validación. </b>
				</br>
		...
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
			...
			if($estadoCotizacionArq == "SELECCIONADO"){
...
<?php
			...
			$atributos ["mensaje"] = "Actualmente no hay Solicitudes de Cotización Disponibles para Validación para 

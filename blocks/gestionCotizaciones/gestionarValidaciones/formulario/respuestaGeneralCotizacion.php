...
class FormularioRegistro {
	...
	function miForm() {
		...
		if($solicitudIndividualesCotizacionSolicitante){
			...
			$atributos ["estilo"] = "jqueryui";
			$atributos ['tipoEtiqueta'] = 'inicio';
			$atributos ["leyenda"] = $this->lenguaje->getCadena ( $esteCampo ) . "RESPUESTA GENERAL";
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
			{
				...
				$esteCampo = "marcoRespuestaEspecificaPro";
				$atributos ['id'] = $esteCampo;
				$atributos ["estilo"] = "jqueryui";
				$atributos ['tipoEtiqueta'] = 'inicio';
				$atributos ["leyenda"] = $this->lenguaje->getCadena ( $esteCampo );
		...
		echo $this->miFormulario->marcoAgrupacion ( 'fin', $atributos );
			...
			$valorCodificado .= "&opcion=registrarRespuestaCotGen";

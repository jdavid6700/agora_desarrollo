...
var_dump($_REQUEST);
                                        ...
                                        $tipo = 'success';
                                        $mensaje = "El objeto ha sido creado exitosamente.";
                                        $boton = "continuar";
        ...
        $this->cadena_sql = $this->miSql->getCadenaSql("consultarObjeto", $id_objeto);
    
        $resultadoObjeto = $esteRecursoDB->ejecutarAcceso($this->cadena_sql, "busqueda");                                        
...
<table class="table table-bordered table-striped table-hover table-condensed">
	<tr >
                ...
                <td align="center">Objeto Contrato</td>	
...
<?php for($contador = 0; $contador < count ( $resultadoObjeto ); $contador ++) { ?>
        <tr bgcolor="#ECECEC">
		<td><?php echo $resultadoObjeto[$contador][1] ?></td>
		<td><?php echo $resultadoObjeto[$contador][2] ?></td>
                <td><?php echo $resultadoObjeto[$contador][3] ?></td>
		<td><?php echo $resultadoObjeto[$contador][4] ?></td>
		<td><?php echo $resultadoObjeto[$contador][5] ?></td>	
	</tr>	
   </table>
        <?php
}                          

	...
	function getCadenaSql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			break;
             ...
             /** Listar codigos de actividades CIIU **/         
			/* CIIU */
            ...
            case 'buscarDependencia' :
                ...
                $cadenaSql = 'SELECT ';
                $cadenaSql .= 'id_dependencia, dependencia ';
                $cadenaSql .= 'FROM ';
                $cadenaSql .= 'prov_dependencia ';
				$cadenaSql .= "ORDER BY dependencia";
                break;                    
			/** Insertar registro de objeto de contrato **/                    
                        case "insertarObjeto":
                            
				$cadenaSql = "INSERT INTO proveedor.prov_objeto_contratar(objetocontratar,codigociiu,id_dependencia,fecharegistro,unidad,cantidad,descripcion,caracteristicas,id_ordenador) ";
                                $cadenaSql .= " VALUES ( ";
                                $cadenaSql .= " '".$variable['objetocontratar']."', ";
                                $cadenaSql .= " ".$variable['codigociiu'].", ";
                                $cadenaSql .= " ".$variable['id_dependencia'].", ";
                                ...
                                $cadenaSql .= " ".$variable['id_ordenador']." ";
                                $cadenaSql .= " )";
                                
			break;
                    
			/** Consultar ultimo valor de la secuencia **/                    
                        case "consultarSecuencia":
				$cadenaSql = "SELECT last_value from  ";
                                $cadenaSql .=  $variable;
			break;
			...
			/** Consultar ultimo valor de la secuencia **/                    
				...
				$cadenaSql = "SELECT * ";
                                $cadenaSql .= "FROM proveedor.prov_objeto_contratar ";
			...
			break;
				...
				$cadenaSql = "SELECT   id,  nombre ";
                                $cadenaSql .= "FROM proveedor.prov_ciiu_division ";

...
class Formulario {
	...
	function formulario() {
		...
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );		
			...
			// ----------------INICIO CONTROL: Campo de Texto TIPO INHABILIDAD--------------------------------------------------------					
				$esteCampo = 'tipo';
				$atributos ['id'] = $esteCampo;
				$atributos ['nombre'] = $esteCampo;
				$atributos ['tipo'] = 'text';
				...
				$atributos ['validar'] = 'required, minSize[2],maxSize[200]';
				...
				unset ( $atributos );
			// ----------------FIN CONTROL: Campo de Texto TIPO INHABILIDAD--------------------------------------------------------
			
			// ----------------INICIO CONTROL: Campo de Texto TIEMPO INHABILIDAD--------------------------------------------------------					
				$esteCampo = 'tiempoInh';
				$atributos ['id'] = $esteCampo;
				$atributos ['nombre'] = $esteCampo;
				$atributos ['tipo'] = 'text';
				...
				$atributos ['tabIndex'] = $tab;
				$atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
				$atributos ['validar'] = 'required, minSize[3],maxSize[100]';
				...
				echo $this->miFormulario->campoCuadroTexto ( $atributos );
				unset ( $atributos );
			// ----------------FIN CONTROL: Campo de Texto TIEMPO INHABILIDAD--------------------------------------------------------
			...
			// ---------------- CONTROL: Cuadro de Texto DESCRICPCION--------------------------------------------------------
				...
				unset ( $atributos );
			// ---------------- FIN CONTROL: Cuadro de Texto DESCRICPCION--------------------------------------------------------
		...
		$valorCodificado .= "&opcion=guardarInhabilidad";

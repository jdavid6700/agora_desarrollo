    ...
    function html() {
        ...
        if (isset($_REQUEST['opcion'])) {
            ...
            switch ($_REQUEST['opcion']) {
                ...
                case "nuevo":
                     include_once($this->ruta . "/formulario/relacionar.php");
                    break;
                ...
                case "registroInterventor":
                     include_once($this->ruta . "/formulario/relacionar.php");
                    break;

                case "gestionInterventor":
                     include_once($this->ruta . "/formulario/gestionar.php");
                    break;

                case "modificarInter":
                     include_once($this->ruta . "/formulario/modificarInt.php");
                    break;              
            }
        } else {

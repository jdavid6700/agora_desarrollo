...
//---------------Inicio Formulario (<form>)--------------------------------
    ...
    if ($_REQUEST['mensaje'] == 'confirma') {
        $tipo = 'success';
        $mensaje = "Se registro el Interventor.<br >";
	    $mensaje .= "Se ha registrado al Usuario (Persona Natural) <strong>" . $_REQUEST['nombre'] . "</strong><br >";
	    $mensaje .= "con Identificación N° <strong>" . $_REQUEST['cedula']. " </strong> como un <b>CONTRATISTA</b> Interventor de CONTRATO<br>";        
        $boton = "continuar";
        ...
        $tipo = 'success';
        $mensaje = "Se actualizo el Interventor.<br >";
        $mensaje .= "Se ha actualizado al Usuario (Persona Natural) <strong>" . $_REQUEST['nombre'] . "</strong><br >";
        $mensaje .= "con Identificación N° <strong>" . $_REQUEST['cedula']. " </strong> <b>CONTRATISTA</b> Interventor de CONTRATO<br>";        
        $boton = "continuar";

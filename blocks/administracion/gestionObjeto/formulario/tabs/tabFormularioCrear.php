...
class registrarForm {
	...
	function miForm() {
		...
		//LISTA DE PROVEEDORES CON MEJOR CLASIFICACION ------- FALTA FILTRAR POR ACTIVIDAD ECONOMICA
		$cadenaSql = $this->miSql->getCadenaSql ( 'proveedoresByClasificacion', $objetoEspecifico[0][1] );

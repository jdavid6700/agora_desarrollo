...
class Formulario {
	...
	function formulario() {
		...
		if(isset($_REQUEST['vigenciaNecesidadCotizacion'])){
			...
			$this->cadena_sql = $this->miSql->getCadenaSql ( "listarObjetosConCotizacionXVigencia", $valorVigenciaCotizacion );
			$resultado = $esteRecursoDB->ejecutarAcceso ( $this->cadena_sql, "busqueda" );
...
<?php
			...
			$atributos ["mensaje"] = "Actualmente no hay Solicitudes de Necesidad Relacionadas con Vigencia <b>".$valorVigenciaCotizacion."</b> en Cotización</br> Ingrese por la pestaña Objeto a Contratar para crear una Relación. <br>";

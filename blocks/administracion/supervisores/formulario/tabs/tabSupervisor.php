...
class FormularioRegistro {
	...
	function formulario() {
		...
		echo $this->miFormulario->formulario ( $atributos );
			...
			$cadenaSql = $this->miSql->getCadenaSql ( 'consultarListaInterventores' );
			$resultadoPersonasInterventoras = $esteRecursoDB->ejecutarAcceso ( $cadenaSql, "busqueda" );

			$resultadoPersonasSupYInt = $resultadoPersonasSupervisoras[0][0] . ',' . $resultadoPersonasInterventoras[0][0];
					...
					$atributos ['miEvento'] = '';
					$atributos ['cadena_sql'] = $cadenaSql = $this->miSql->getCadenaSql ( 'consultarPersonasNoSupervisoras', $resultadoPersonasSupYInt );

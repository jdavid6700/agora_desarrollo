	...
	function getCadenaSql($tipo, $variable = '') {
		...
		switch ($tipo) {
			...
			case "consultar_tipo_proveedor" :
				$cadenaSql = " SELECT tipopersona FROM proveedor.informacion_proveedor ";
			...
			case "informacion_por_proveedor_juridica" :
				...
				$cadenaSql.=" FROM proveedor.informacion_proveedor P";
				$cadenaSql.=" JOIN parametro.ciudad L ON P.id_ciudad_contacto = L.id_ciudad";
				$cadenaSql.=" JOIN parametro.departamento LD ON L.id_departamento = LD.id_departamento";
				$cadenaSql.=" JOIN parametro.pais LP ON LD.id_pais = LP.id_pais";
				$cadenaSql.=" JOIN parametro.parametro_estandar E ON P.estado = E.id_parametro";
				$cadenaSql.=" JOIN parametro.banco S ON P.id_entidad_bancaria = S.id_codigo";
				$cadenaSql.=" JOIN proveedor.proveedor_representante_legal R ON P.id_proveedor = R.id_proveedor";
				$cadenaSql.=" JOIN proveedor.informacion_persona_natural PN ON PN.num_documento_persona = R.id_representante";
				$cadenaSql.=" JOIN parametro.parametro_estandar PNT ON PNT.id_parametro = PN.tipo_documento";
				$cadenaSql.=" JOIN parametro.pais PNR ON PNR.id_pais = PN.id_pais_nacimiento";
				$cadenaSql.=" JOIN parametro.parametro_estandar PER ON PER.id_parametro = PN.perfil";
				$cadenaSql.=" JOIN proveedor.informacion_persona_juridica PJ ON PJ.num_nit_empresa = P.num_documento";
				$cadenaSql.=" JOIN parametro.ciudad JL ON PJ.id_ciudad_origen = JL.id_ciudad";
				$cadenaSql.=" JOIN parametro.departamento JLD ON JL.id_departamento = JLD.id_departamento";
				$cadenaSql.=" JOIN parametro.pais JLP ON JLD.id_pais = JLP.id_pais";
				$cadenaSql.=" JOIN parametro.tipo_conformacion TC ON TC.id_conformacion = PJ.id_tipo_conformacion";
				$cadenaSql.=" WHERE";
			...
			case "informacion_por_proveedor_natural" :
				...
				$cadenaSql.=" JOIN parametro.parametro_estandar E ON P.estado = E.id_parametro";
				$cadenaSql.=" JOIN parametro.banco S ON P.id_entidad_bancaria = S.id_codigo";
				$cadenaSql.=" JOIN proveedor.informacion_persona_natural PN ON PN.num_documento_persona = P.num_documento";
				$cadenaSql.=" JOIN parametro.parametro_estandar PNT ON PNT.id_parametro = PN.tipo_documento";
				$cadenaSql.=" JOIN parametro.pais PNR ON PNR.id_pais = PN.id_pais_nacimiento";
				$cadenaSql.=" JOIN parametro.parametro_estandar PER ON PER.id_parametro = PN.perfil";
				$cadenaSql.=" WHERE";

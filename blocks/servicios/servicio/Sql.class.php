	...
	function getCadenaSql($tipo, $variable = '') {
		...
		switch ($tipo) {
			...
			case "informacion_por_proveedor_juridica" :
				...
				$cadenaSql.=" JOIN core.ciudad L ON P.id_ciudad_contacto = L.id_ciudad";
				$cadenaSql.=" JOIN core.departamento LD ON L.id_departamento = LD.id_departamento";
				$cadenaSql.=" JOIN core.pais LP ON LD.id_pais = LP.id_pais";
				$cadenaSql.=" JOIN agora.parametro_estandar E ON P.estado = E.id_parametro";
				$cadenaSql.=" JOIN core.banco S ON P.id_entidad_bancaria = S.id_codigo";
				...
				$cadenaSql.=" JOIN core.pais PNR ON PNR.id_pais = PN.id_pais_nacimiento";

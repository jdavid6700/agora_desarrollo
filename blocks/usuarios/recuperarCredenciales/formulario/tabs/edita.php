	...
	function miForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			{	
				...
				$mensajeLey = "<b>La contraseña es una información secreta que se nos solicita para acceder al Sistema, y que solo debe conocer el propietario del mismo. 
			...
			$valorCodificado .= "&opcion=preguntasClave";

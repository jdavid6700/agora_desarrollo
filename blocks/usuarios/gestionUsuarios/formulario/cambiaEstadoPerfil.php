...
class mensajeForm {
	...
	function miForm() {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      			{
                                    ...
                                    switch ($_REQUEST ['opcion']) {
                                        case "inhabilitarPerfil": 
                                                $mensaje = "Esta seguro de Inhabilitar el perfil <b>".$_REQUEST ['rol_alias']."</b> del usuario <b>".$resultadoUsuarios[0]['nombre']." ".$resultadoUsuarios[0]['apellido']."</b> ?";
                                                $boton = "inhabilitarPerfil";
                                        break;        
                                        case "habilitarPerfil": 
                                                $mensaje = "Esta seguro de habilitar  el perfil <b>".$_REQUEST ['rol_alias']."</b> del usuario <b>".$resultadoUsuarios[0]['nombre']." ".$resultadoUsuarios[0]['apellido']."</b> ?";
                                                $boton = "habilitarPerfil";
                                        break;
                                    }
		...
		$valorCodificado .= "&opcion=".$boton;
                ...
                $valorCodificado .= "&identificacion=".$resultadoUsuarios[0]['identificacion'];
                $valorCodificado .= "&id_subsistema=".$_REQUEST['id_subsistema'];
                $valorCodificado .= "&rol_id=".$_REQUEST['rol_id'];
                $valorCodificado .= "&rol_alias=".$_REQUEST['rol_alias'];

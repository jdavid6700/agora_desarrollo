			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      			{
                                    ...
                                    switch ($_REQUEST ['opcion']) {
                                        case "inhabilitar": 
                                                $mensaje = "Esta seguro de Inhabilitar el usuario ".$resultadoUsuarios[0]['nombre']." ".$resultadoUsuarios[0]['apellido']." ?";
                                                $boton = "inhabilitar";
                                        break;        
                                        case "habilitar": 
                                                $mensaje = "Esta seguro de habilitar el usuario ".$resultadoUsuarios[0]['nombre']." ".$resultadoUsuarios[0]['apellido']." ?";
                                                $boton = "habilitar";
                                        break;
                                    }

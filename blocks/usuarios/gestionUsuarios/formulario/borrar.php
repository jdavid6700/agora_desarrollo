	...
	function miForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      			{
                                    $tipo = 'warning';
                                    $mensaje = "Esta seguro de Eliminar el usuario <b>".$resultadoUsuarios[0]['nombre']." ".$resultadoUsuarios[0]['apellido']."</b> ?";
                                    $mensaje.= "<br>Recuerde que una vez realizada esta acción, NO se pueden recuperar los datos del usuario!";
                                    $boton = "borrar";
